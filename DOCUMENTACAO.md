...
- **Academia e Corrida do Vini** — `kg-activity-ui.js` reutiliza o mesmo documento diário da página Hábitos. Academia registra os oito grupos musculares já existentes e água de 0,5 L a 5 L; Corrida registra as distâncias de 2,5 km a 10 km. O botão final salva somente depois das marcações, preservando os demais campos do dia. A aba Corrida já registra o realizado e reserva a evolução do plano de treino para a etapa seguinte.
