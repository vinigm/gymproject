...
- **Academia e Corrida do Vini** — `kg-activity-ui.js` reutiliza o mesmo documento diário da página Hábitos. Academia registra os oito grupos musculares já existentes e água de 0,5 L a 5 L. Corrida aceita distância livre, tempo, observações e vínculo opcional com uma planilha flexível de 8 etapas rumo aos 5 km em pace-alvo de 5:50/km. O plano foi recalibrado a partir da primeira corrida-base enviada (aprox. 4,74 km totais, 24:12 correndo, FC média 137 e máxima 153), começando em blocos de 3 min correndo e 1min30 caminhando. Cada sessão mostra uma faixa de pace referente somente aos blocos correndo; a caminhada é livre para recuperação. Cada etapa tem sessões leve, intervalada e longa; o check guarda a data, distância, tempo e pace global efetivamente registrados, sem prender o treino a um dia da semana. Corridas livres entram no histórico e nos gráficos sem avançar a planilha. O botão final salva somente depois das marcações, preservando os demais campos do dia.
