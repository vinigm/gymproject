...
const expectedPresets = {
  ...
  cafe_ovos_cozidos: { groupId: "cafe_manha", foods: ["ovos_cozidos"], amounts: { ovos_cozidos: 3 } },
  almoco_padrao: { groupId: "almoco", foods: ["vegetais", "arroz", "frango"], amounts: { vegetais: 50, arroz: 150, frango: 120 } },
